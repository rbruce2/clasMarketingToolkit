...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/reports/reportsModule.js',
			'app/modules/reports/reportsCtrl.js',
			'app/modules/reports/reportsRoute.js',
			'app/modules/reports/reportsService.js',
			'app/modules/reports/reports-test.js',
		],
